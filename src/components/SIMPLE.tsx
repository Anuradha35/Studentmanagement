...
NOW AB YE BHI WORK KAR RAHA HAI AB MUJHE YE SAMAGH NAHI AA RAHA KI AAGE KAISE DESIGN KARU AND USKO
  ...
  1. SINGLE PAYMENT -> LIKE JIS STUDENT KO HOSTEL LENA HAI TO USNE APNE COUSE FEE WALI RECIEPT OR URT/UPI ID YA BOTH MEANS KUCH CASH AND KUCH ONLINE MAIN HI APNI HOSTEL RENT BHI ADD KARWA DIYA TO UNKA RECIEPT NO. OR UTR/UPI ID YA BOTH SAME HO GAYA
